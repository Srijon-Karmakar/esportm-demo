...
const PlayerStats = () => {
  ...
  const [controls, setControls] = useState({
    speed: { active: true, value: 320 },
    stamina: { active: false, value: 0 },
    health: { active: true, value: 120 },
    tackle: { active: false, value: 0 },
    shot: { active: true, value: 412 }
  });
  ...
  const handleGoChat = () => navigate('/ChatPage');
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.mainContent}>
        ...
        {/* Action Buttons */}
        <div style={styles.headerButtonsStyle}>
          <button style={styles.buttonStyle} onClick={handleGoHome}>Home</button>
          <button style={styles.buttonStyle} onClick={handleGoChat}>Chat</button>
          <button style={{ ...styles.buttonStyle, backgroundColor: '#dc3545' }} onClick={handleLogout}>Logout</button>
        </div>
          ...
          <div style={styles.gridContainer}>
            ...
            <div style={styles.profileCard}>
              ...
              <div style={styles.statsGrid}>
                ...
                <div style={styles.statItem}>
                  <div style={styles.statLabel}>Follows</div>

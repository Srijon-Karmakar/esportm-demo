  ...
  return (
    <div className="fan-sidebar">
      ...
      <div className="avatar-section">
        ...
        <h4 className="username">Welcome <br /> {username} </h4>
...
<div className="nav-section">
        <NavLink to="/NmdDashboard" className={`nav-btn ${location.pathname === '/NmdDashboard' ? 'active' : ''}`}>
           DASHBOARD
        </NavLink>
        <NavLink to="/NmdPlayerStats" className={`nav-btn ${location.pathname === '/NmdPlayerStats' ? 'active' : ''}`}>
           STATISTICS
        </NavLink>
        <NavLink to="/NmdClubOffers" className={`nav-btn ${location.pathname === '/NmdClubOffers' ? 'active' : ''}`}>
           OFFERS
        </NavLink>
        <NavLink to="/NmdApplication" className={`nav-btn ${location.pathname === '/NmdApplication' ? 'active' : ''}`}>
           APPLICATIONS
        </NavLink>
        <NavLink to="/NmdChatPage" className={`nav-btn ${location.pathname === '/NmdChatPage' ? 'active' : ''}`}>
           MESSAGES
        </NavLink>
        <NavLink to="/Timeline" className={`nav-btn ${location.pathname === '/Timeline' ? 'active' : ''}`}>
           TIMELINE
        </NavLink>
        <NavLink to="/user/profile2" className={`nav-btn ${location.pathname === '/PlayerProfile2' ? 'active' : ''}`}>
           PROFILE
        </NavLink>
      </div>
